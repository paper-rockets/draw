...
export class SampleModelFactory {
  ...
  public static createCyberHelmet(): THREE.Object3D {
    ...
    // Deform skull into aerodynamic helmet shape
  ...
  public static createCeramicVase(): THREE.Object3D {
    ...
    // Lathe profile points
    const points: THREE.Vector2[] = [];
    for (let i = 0; i <= 30; i++) {
      const t = i / 30;
      const y = (t - 0.5) * 2.4;
      // Elegant vase curvature
